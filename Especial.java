public class Especial extends Conta {
    ...
    public Especial (String nome, int cpf, double saldo, int numeroConta, double jurosCobrados) {
    ...
    protected double creditoDebito (double valor) {
        ...
        else if(saldo + valor >= 0 - LIMITE_CHEQUE_ESPECIAL) saldo += valor; //O + é pelo fato do valor vir negativo nesse else
    ...
    protected void aplicarJurosCheque () {
